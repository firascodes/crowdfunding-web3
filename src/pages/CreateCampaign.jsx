...
const CreateCampaign = () => {
  ...
  sm:p-10 p-4"
    >
      ...
      <div className="w-full flex justify-start items-center p-4 bg-[#1dc071] h-[60px] rounded-[10px] mt-8">
        <img
          src={money}
          alt="money"
          className="w-[30px] h-[30px] object-contain"
        />
        <h4 className="font-epilogue font-bold text-lg text-white ml-[20px]">
